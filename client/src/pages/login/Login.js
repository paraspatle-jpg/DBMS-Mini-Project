...
export const Login = () => {
  return (
    ...
    <button className="main-elements" style={{ width: '60%' }} id="login" type="button" >Login</button>
    <p className="element">Don't have an account?<a><Link to="/SignUp">SignUp</Link></a></p>
  </div>
  )
}
